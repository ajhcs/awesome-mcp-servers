...
- <img src="https://cdn.simpleicons.org/uml/FABD14" height="14" /> [cameo-mcp-bridge](https://github.com/ajhcs/cameo-mcp-bridge) - MCP server connecting AI assistants to CATIA Magic / Cameo Systems Modeler with 37 tools for querying, creating, and modifying SysML/UML models. Supports OOSEM methodology workflows, elements, relationships, diagrams, and Groovy macro execution.
